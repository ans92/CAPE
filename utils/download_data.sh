...
#cp utils/download_embeddings.py $FOLDER/fast #-- changed this line with the following
cp /content/drive/MyDrive/Research/czsl-main/utils/download_embeddings.py $FOLDER/fast
...
#python utils/reorganize_utzap.py # ---commented this line to change the below line
python /content/drive/MyDrive/Research/czsl-main/utils/reorganize_utzap.py