...
class GraphFull(nn.Module):
    def __init__(self, dset, args):
        ...
        print('### GraphFull Class __init__ function executed ###')
    def train_forward_normal(self, x):
        ...
        print('### GraphFull Class train_forward_normal function executed ###')
        return  loss, None
    ...
    def val_forward_dotpr(self, x):
        ...
        print('### GraphFull class val_forward_dotpr function executed ###')
        return None, scores
    ...
    def val_forward_distance_fast(self, x):
        ...
        for itr, pair in enumerate(self.dset.pairs):
            scores[pair] = score[:,self.dset.all_pair2idx[pair]]
        print('### GraphFull class val_forward_distance_fast function executed ###')
        return None, scores
    ...
    def forward(self, x):
        ...
        print('### GraphFull class forward function executed ###')
        return loss, pred